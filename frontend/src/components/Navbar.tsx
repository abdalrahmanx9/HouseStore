...
import { ShoppingBag, LogIn, Moon, Sun, Store, Shield, Menu, X, Package, User, Search, Heart } from 'lucide-react'
        ...
        >
          <div className={`w-full h-full flex items-center justify-between transition-all duration-500 ${isScrolled ? 'px-6' : 'px-6 md:px-8'}`}>
            ...
            <nav className="flex items-center space-x-2 md:space-x-3">
              ...
              {/* Wishlist */}
              <Link to="/wishlist" className="p-2 rounded-full hover:bg-surface text-foreground/70 hover:text-red-400 transition-colors" title="Wishlist">
          ...
          <>
            ...
            >
              ...
              <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
                ...
                <Link to="/wishlist" className="flex items-center gap-3 px-4 py-3 rounded-xl text-foreground/70 hover:text-foreground hover:bg-surface-hover transition-colors font-medium">
